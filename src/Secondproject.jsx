...
export default function Secondproject() {
  ...
  return (
      ...
      <h1  data-aos="fade-up"
        data-aos-duration="900" className='text-4xl font-Text font-medium m-auto leading-8 lg:text-5xl text-black'>Naturalit
:A site to buy   <br />everything related to natural   <br />foods  </h1>       </div>
      <img  data-aos="fade-up"
      loading="lazy"
        data-aos-duration="900" className="w-3/4  object-cover rounded-sm mt-24 m-auto" src={FourthProjectImage} />
...
Welcome to your one-stop shop for all things natural and wholesome! Whether you're looking for organic pantry staples, farm-fresh produce, or nutritious snacks, we provide a wide selection of high-quality natural foods to support a healthy and sustainable lifestyle.        </h1>
 </div>
      <div className=' w-3/4 h-fit bg-transparent flex flex-col items-center m-auto text-start max-w-3xl mt-14'>

<h1  data-aos="fade-up"
        data-aos-duration="900" className='text-lg font-Text font-normal m-auto lg:text-xl text-neutral-600'>
From organic fruits and vegetables to minimally processed grains, nuts, and seeds, our store is dedicated to offering foods that are free from artificial additives and preservatives. We carefully source products from trusted farmers and producers who prioritize sustainability, ethical farming practices, and the highest nutritional standards.     </h1>
 </div>
      <div className=' w-3/4 h-fit bg-transparent flex flex-col items-center m-auto text-start max-w-3xl mt-14'>

<h1  data-aos="fade-up"
        data-aos-duration="900" className='text-lg font-Text font-normal m-auto lg:text-xl text-neutral-600'>
Explore a variety of categories including organic groceries, gluten-free and plant-based options, superfoods, and more. Our collection is designed to cater to every diet, from vegan and vegetarian to paleo and keto, ensuring you find the best natural foods that fit your lifestyle.    </h1>
 </div>
      <div className=' w-3/4 h-fit bg-transparent flex flex-col items-center m-auto text-start max-w-3xl mt-14'>

<h1  data-aos="fade-up"
        data-aos-duration="900" className='text-lg font-Text font-normal m-auto lg:text-xl text-neutral-600'>
With easy browsing, personalized recommendations, and community reviews, finding the right natural foods has never been simpler. Nourish your body with nature’s finest ingredients—shop with us today and embrace a healthier, more natural way of living!  </h1>
 </div>
