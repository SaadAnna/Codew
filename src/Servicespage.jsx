...
<hr className="w-20 h-1 mt-7  bg-black" />
      ...
      <div
      className="block justify-center items-center mt-28 text-center lg:flex lg:justify-around lg:items-center lg:text-center lg:mt-32">
     
      <div  data-aos="fade-up"
     data-aos-duration="900" className=" w-72 h-40 border border-solid border-neutral-200 rounded-lg block justify-center text-center mt-5 items-center m-auto cursor-pointer hover:bg-neutral-100 lg:w-44 lg:h-40 lg:border lg:border-solid lg:border-neutral-200 lg:rounded-lg lg:block lg:justify-center lg:text-center lg:items-center  lg:cursor-pointer lg:hover:bg-neutral-100">
      <svg className="w-10 h-10 m-auto mt-3 text-black dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  <path d="M11.782 5.72a4.773 4.773 0 0 0-4.8 4.173 3.43 3.43 0 0 1 2.741-1.687c1.689 0 2.974 1.972 3.758 2.587a5.733 5.733 0 0 0 5.382.935c2-.638 2.934-2.865 3.137-3.921-.969 1.379-2.44 2.207-4.259 1.231-1.253-.673-2.19-3.438-5.959-3.318ZM6.8 11.979A4.772 4.772 0 0 0 2 16.151a3.431 3.431 0 0 1 2.745-1.687c1.689 0 2.974 1.972 3.758 2.587a5.733 5.733 0 0 0 5.382.935c2-.638 2.933-2.865 3.137-3.921-.97 1.379-2.44 2.208-4.259 1.231-1.253-.673-2.19-3.443-5.963-3.317Z"/>
</svg>
<h4 className="font-Text text-black font-semibold text-xl mt-4">Tailwindcss</h4>
...
<h4 className="font-Text text-black font-semibold text-xl mt-4">React</h4>

      </div>
      <div  data-aos="fade-up"
     data-aos-duration="900" className=" w-72 h-40 border border-solid border-neutral-200 rounded-lg block justify-center text-center mt-5 items-center m-auto cursor-pointer hover:bg-neutral-100 lg:w-44 lg:h-40 lg:border lg:border-solid lg:border-neutral-200 lg:rounded-lg lg:block lg:justify-center lg:text-center lg:items-center  lg:cursor-pointer lg:hover:bg-neutral-100">
      <svg className="w-10 h-10 m-auto mt-3 text-black dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
<h4 className="font-Text text-black font-semibold text-xl mt-4">Design</h4>
...
<h4 className="font-Text text-black font-semibold text-xl mt-4">HTML</h4>

      </div>
       </div>
       <div
             className="block justify-center items-center mt-14 text-center lg:flex lg:justify-around lg:items-center lg:text-center lg:mt-14"
>
...
<h4 className="font-Text text-black font-semibold text-xl mt-4">CSS</h4>
...
<h4 className="font-Text text-black font-semibold text-xl mt-4">Git Hub</h4>
...
<h4 className="font-Text text-black font-semibold text-xl mt-4">NPM</h4>
...
<h4 className="font-Text text-black font-semibold text-xl mt-4">Stackoverflow</h4>
      ...
      <div  data-aos="fade-up"
     data-aos-duration="900"   className="   w-10/12 m-auto mt-10 lg:w-96 lg:h-96 border border-solid border-neutral-200 p-5 rounded-lg hover:bg-neutral-100 cursor-pointer">
      <svg className="w-14 h-14 m-auto mt-4 text-black dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
...
Create Intuitive And Visually Appealing User Interfaces <br />That Enhance User Experience.
      ...
      <div   data-aos="fade-up"
     data-aos-duration="900"  className="   w-10/12 m-auto mt-10 lg:w-96 lg:h-96 border border-solid border-neutral-200 p-5 rounded-lg hover:bg-neutral-100 cursor-pointer">
      <svg className="w-14 h-14 m-auto mt-4 text-black dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
Build Responsive And Interactive Web Applications<br /> Using Modern Front-End Technologies.</p>
      ...
      <div className=" block justify-center items-center mt-10 text-center m-auto  lg:flex lg:justify-evenly lg:m-auto lg:mt-10 lg:items-center">
...
Optimize Your Web Applications For Speed And Efficiency<br /> To Improve User Satisfaction And SEO.</p>
      ...
      <div  data-aos="fade-up"
     data-aos-duration="900" className=" mt-10   w-10/12 m-auto lg:w-96 lg:h-96 border border-solid border-neutral-200 p-5 rounded-lg hover:bg-neutral-100 cursor-pointer">
      <svg className="w-14 h-14 m-auto mt-4  text-black dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
Development Shopify Applications and Stores with High-Quality<br /> 
 And Add E-commerce Features To Your Store For Better Performance And Speed</p>
        ...
        <div data-aos="fade-up"
     data-aos-duration="900"  className='flex justify-center items-center text-center mt-14'>
      <Link
            to="/Choseservice"
      ...
      <div data-aos="fade-up" 
     data-aos-duration="900"  className="flex flex-col text-center items-center mt-9">
      <div className="w-16 h-16 m-auto rounded-full mt-4 bg-neutral-300 flex items-center justify-center mb-4 z-10">
      <svg className="w-10 h-10 text-gray-950 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
We Analyze Your Needs And <br />Project Requirements.
     ...
     data-aos-duration="900"  className="flex flex-col text-center items-center mt-9">
      <div className="w-16 h-16 m-auto rounded-full mt-4 bg-neutral-300 flex items-center justify-center mb-4 z-10">
      <svg className="w-10 h-10  text-gray-950 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  <path fillRule="evenodd" d="M15.514 3.293a1 1 0 0 0-1.415 0L12.151 5.24a.93.93 0 0 1 .056.052l6.5 6.5a.97.97 0 0 1 .052.056L20.707 9.9a1 1 0 0 0 0-1.415l-5.193-5.193ZM7.004 8.27l3.892-1.46 6.293 6.293-1.46 3.893a1 1 0 0 1-.603.591l-9.494 3.355a1 1 0 0 1-.98-.18l6.452-6.453a1 1 0 0 0-1.414-1.414l-6.453 6.452a1 1 0 0 1-.18-.98l3.355-9.494a1 1 0 0 1 .591-.603Z" clipRule="evenodd"/>
</svg>
</div>
...
We Launch Your Project Using <br />Efficient Deployment Strategies.
     ...
     data-aos-duration="900"  className="flex flex-col text-center items-center mt-9">
      <div className="w-16 h-16 m-auto rounded-full mt-4 bg-neutral-300 flex items-center justify-center mb-4 z-10">
      <svg className="w-10 h-10 m-auto text-gray-950 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
Ongoing Support And Updates Keep <br /> Your Project Running Smoothly.
      ...
      <div data-aos="fade-up"
     data-aos-duration="900"  className=" w-11/12 m-auto h-full  p-20 rounded-lg block justify-center items-center text-center mt-20 bg-neutral-100">
