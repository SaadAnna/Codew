      ...
      return (
        ...
        className="ml-5 block text-start justify-start items-start mt-28 lg:ml-8"
         > 
          ...
          <div  data-aos="fade-up"
        data-aos-duration="900" className="  m-auto mt-20 block text-start w-10/12 p-5 border border-solid border-neutral-200 rounded-lg lg:block lg:text-start lg:w-96 lg:h-80 lg:p-5 lg:border lg:border-solid lg:border-neutral-200 lg:rounded-lg">
...
Custom features and integrations<br /> to enhance your store's  <br />capabilities.
          ...
          <div className="block  mt-10 justify-center items-center text-center m-auto lg:flex  lg:justify-evenly lg:items-center lg:text-start lg:mt-10">
